                    ...
                    <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                            <form onSubmit={handleSubmit}>
                                {ok && <div className="bg-green-200 py-1 text-center"><p>An activation link has been sent to <span className="text-blue-600">{email}</span></p></div>}
                                <div>
                                ...
                                <div className="flex justify-between mt-2">
                                    <div className="text-center">
                                        <Link to='/forgot-password' className="inline-block text-sm text-blue-500 dark:text-blue-500 align-baseline hover:text-blue-800" href="#">
                                            Forgot Password?
                                        </Link>
                                    </div>
                                    <div className="text-center">
